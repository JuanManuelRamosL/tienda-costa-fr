      ...
      <div className={styles.containerButtonInteracciones}>
{
  ...
  ) :   <button className={styles.interaccionesDelete} onClick={() => handleRemoveFromCart(product.id)}>
  <h3  onClick={() => handleRemoveFromCart(product.id)} className={styles.textAdd}>
